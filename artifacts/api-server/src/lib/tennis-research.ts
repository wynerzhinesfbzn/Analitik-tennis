...
🇷🇺 РУССКОЯЗЫЧНЫЕ ИСТОЧНИКИ — выполни ТОЛЬКО если предыдущие 13 запросов не дали достаточно информации ПО ХОТЯ БЫ ОДНОМУ игроку (травмы/форма/личный контекст):
14. "${player1}" OR "${player2}" теннис травма форма ${today.slice(0, 7)} site:sovsport.ru OR site:championat.com OR site:sports.ru — русскоязычные новости (травмы, форма, интервью)
15. "${player1}" OR "${player2}" теннис ${today.slice(0, 7)} site:gotennis.ru OR site:sport.rambler.ru — тактический анализ и прогнозы на русском

Примечание: русские источники особенно ценны для игроков из СНГ (Медведев, Хачанов, Рублёв, Самсонова и др.) и для турниров ATP/WTA 250–500, слабо освещённых в зарубежной прессе. Для топ-игроков (Джокович, Синнер, Алькарас и т.д.) английских источников обычно достаточно.

Используй web_search для КАЖДОГО из 13 обязательных запросов + русские если нужны. Итого 13–15 поисков.
